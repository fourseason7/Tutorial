    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SystemInformationID = table.Column<byte>(nullable: false, comment: "Current version number of the AdventureWorks 2014 sample database. ")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DatabaseVersion = table.Column<string>(name: "Database Version", maxLength: 25, nullable: false, comment: "Current version number of the AdventureWorks 2014 sample database. "),
                    VersionDate = table.Column<DateTime>(type: "datetime", nullable: false, comment: "Current version number of the AdventureWorks 2014 sample database. "),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Current version number of the AdventureWorks 2014 sample database. ")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MainMenu = table.Column<string>(unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuMain", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Roles = table.Column<string>(unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubMenu = table.Column<string>(unicode: false, maxLength: 50, nullable: true),
                    Controller = table.Column<string>(unicode: false, maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuSub", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuSub_MenuMain",
                        column: x => x.MainMenuId,
                        principalTable: "MenuMain",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuSub_UserRoles",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserList__3214EC0707D78655", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_UserLists_UserRoles",
                        column: x => x.RoleId,
                        principalTable: "UserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuSub_MainMenuId",
                table: "MenuSub",
                column: "MainMenuId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuSub_RoleId",
                table: "MenuSub",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLists_RoleId",
                table: "UserLists",
                column: "RoleId");
