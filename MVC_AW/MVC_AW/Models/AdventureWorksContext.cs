...
namespace MVC_AW.Models
{
    public partial class AdventureWorksContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MenuMain>(entity =>
            {
            ...
            modelBuilder.Entity<MenuSub>(entity =>
            {
                ...
                entity.HasOne(d => d.MainMenu)
                    .WithMany(p => p.MenuSub)
                    .HasForeignKey(d => d.MainMenuId)
                    .HasConstraintName("FK_MenuSub_MenuMain");

                entity.HasOne(d => d.Role)
                    .WithMany(p => p.MenuSub)
                    .HasForeignKey(d => d.RoleId)
                    .HasConstraintName("FK_MenuSub_UserRoles");
            });
            ...
            modelBuilder.Entity<UserLists>(entity =>
            {
                ...
                entity.HasOne(d => d.Role)
                    ...
                    .HasForeignKey(d => d.RoleId)
                    .HasConstraintName("FK_UserLists_UserRoles");
            });
