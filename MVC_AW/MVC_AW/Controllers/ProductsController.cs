...
namespace MVC_AW.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            //var adventureWorksContext = _context.Product.Include(p => p.ProductModel).Include(p => p.ProductSubcategory).Include(p => p.SizeUnitMeasureCodeNavigation).Include(p => p.WeightUnitMeasureCodeNavigation);
            var adventureWorksContext = _context.Product;
