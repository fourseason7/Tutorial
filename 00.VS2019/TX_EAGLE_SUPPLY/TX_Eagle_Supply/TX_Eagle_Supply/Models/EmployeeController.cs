...
namespace TX_Eagle_Supply.Models
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Login,Password,Email,EmployeeTypeId,IsActive,CreatedDate,ModifiedDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Login,Password,Email,EmployeeTypeId,IsActive,CreatedDate,ModifiedDate")] Employee employee)
        {
            if (ModelState.IsValid)
            {
